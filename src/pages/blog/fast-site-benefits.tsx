  ...
  <Layout>
    <div className="container-custom py-20 font-sans blog-fonts">
      ...
      <header className="mb-8 text-center max-w-2xl mx-auto">
        <h1 className="text-4xl md:text-5xl font-bold mb-3 leading-tight">The Business Benefits of a Fast Website</h1>
        <div className="flex flex-col items-center gap-2 mb-2">
          <span className="text-base font-medium text-muted-foreground">By Ram Sanehi, Founder, Scalvex</span>
          <span className="text-xs text-muted-foreground">3 min read · Performance</span>
        </div>
      </header>
      ...
      <section className="mb-8 max-w-2xl mx-auto">
        <Card className="bg-background p-4 border-l-4 border-accent">
          ...
          <p className="mb-2">Service businesses, consultants, agencies, and founders who want to turn site speed into a competitive advantage and more leads.</p>
        </Card>
      </section>
      <Separator className="my-8" />
      <section className="mb-10 max-w-2xl mx-auto">
        <Card className="bg-muted/40 p-6 mb-6">
          ...
          <p className="text-base leading-relaxed mb-2">In 100+ service business audits, slow load times are a top conversion killer. The problem isn’t just speed—it’s friction, confusion, and missing trust signals. Most agencies miss these, but they’re fixable.</p>
        </Card>
      </section>
      <Separator className="my-8" />
      <section className="mb-10 max-w-2xl mx-auto">
      ...
      <Separator className="my-8" />
      <section className="mb-10 max-w-2xl mx-auto">
        <h2 className="text-2xl font-bold mb-4">Speed Optimization Checklist</h2>
        <ol className="list-decimal list-inside space-y-8">
          <li>
            <h3 className="text-lg font-semibold mb-2">Optimize Images</h3>
            <p className="mb-2">Compress and serve images in next-gen formats for faster load times. Use specifics and numbers.</p>
      ...
      <section className="mb-10 max-w-2xl mx-auto">
        <Card className="bg-background p-6 border border-accent">
          <h3 className="text-lg font-semibold mb-2">Ready to Turn Speed Into Leads?</h3>
          <p className="text-base leading-relaxed mb-4">Get a free, expert-led speed audit. You’ll discover exactly what’s blocking conversions, what to fix, and how to turn traffic into qualified leads. No sales pitch—just actionable insights from real client projects.</p>
