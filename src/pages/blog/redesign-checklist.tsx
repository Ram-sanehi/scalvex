        ...
        <div className="space-y-10 relative z-10">
          <section>
            <div className="p-6 rounded-2xl border border-accent/20 bg-accent/[0.02] shadow-[0_2px_8px_-3px_rgba(59,175,218,0.05)] relative overflow-hidden group">
              ...
              <p className="text-sm leading-relaxed text-muted-foreground">
                Service businesses, consultants, agencies, and founders planning a redesign to drive more leads and trust.
              </p>
            </div>
          </section>
          ...
          <section>
            <div className="p-6 rounded-2xl border border-border/40 bg-card/60 backdrop-blur-sm shadow-[0_2px_8px_-3px_rgba(0,0,0,0.02)]">
              <p className="text-lg leading-relaxed mb-3 font-bold text-foreground">Redesigning but still not converting? You’re not alone.</p>
              <p className="text-sm sm:text-base leading-relaxed text-muted-foreground/90">
                In 100+ redesign audits, the same issues appear: new look, same conversion problems. The problem isn’t design—it’s friction, confusion, and missing trust signals. Most agencies miss these, but they’re fixable.
              </p>
            </div>
          </section>

          <section>
            <h2 className="text-xl sm:text-2xl font-bold mb-5 tracking-tight text-foreground">Why Most Redesigns Don’t Convert</h2>
            <div className="p-6 rounded-2xl border border-border/45 bg-card/45 shadow-[0_2px_8px_-3px_rgba(0,0,0,0.02)] relative group overflow-hidden">
              ...
              <ul className="space-y-3 mb-5">
                <li className="flex items-start gap-2.5 text-sm text-muted-foreground leading-relaxed">
                  ...
                  <span>Redesign focuses on visuals, not conversion</span>
                </li>
                <li className="flex items-start gap-2.5 text-sm text-muted-foreground leading-relaxed">
                  <span className="w-1.5 h-1.5 rounded-full bg-accent mt-2 flex-shrink-0" />
              ...
              <p className="text-sm font-semibold text-foreground border-t border-border/40 pt-4 mt-2">Visual polish and animations don’t fix these. Action and clarity do.</p>
            </div>
          </section>

          <section>
            <h2 className="text-xl sm:text-2xl font-bold mb-6 tracking-tight text-foreground">Redesign Optimization Checklist</h2>
              ...
              <li className="p-6 rounded-2xl border border-border/30 bg-card shadow-[0_2px_8px_-3px_rgba(0,0,0,0.02)] relative group">
                <div className="flex gap-4">
                  ...
                  <div className="w-full">
                    <h3 className="text-base font-bold text-foreground mb-1">Unify Redesign and Conversion</h3>
                    <p className="text-sm text-muted-foreground leading-relaxed mb-4">Redesign for both aesthetics and conversion. Don’t treat them as separate projects.</p>
                    <div className="p-4 rounded-xl border border-border/20 bg-muted/20 space-y-2.5">
                      <div className="flex items-start gap-2.5 text-xs text-muted-foreground/90 leading-relaxed">
                        ...
                        <span>Map redesign to buyer journey and conversion path</span>
                      </div>
                      <div className="flex items-start gap-2.5 text-xs text-muted-foreground/90 leading-relaxed">
                        <span className="w-1.5 h-1.5 rounded-full bg-accent/60 mt-1.5 flex-shrink-0" />
          ...
          <section>
            <div className="p-8 border border-accent/20 rounded-2xl bg-gradient-to-br from-accent/[0.03] to-transparent shadow-lg relative overflow-hidden">
              <div className="absolute top-0 left-0 w-1.5 h-full bg-accent" />
              <h3 className="text-lg font-semibold mb-2 text-foreground">Ready to Redesign for Results?</h3>
