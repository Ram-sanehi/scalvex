  ...
  <Layout>
    <div className="container-custom py-20 font-sans blog-fonts">
      ...
      <header className="mb-8 text-center max-w-2xl mx-auto">
        <h1 className="text-4xl md:text-5xl font-bold mb-3 leading-tight">How SEO-First Websites Generate Consistent Leads</h1>
        <div className="flex flex-col items-center gap-2 mb-2">
          <span className="text-base font-medium text-muted-foreground">By Ram Sanehi, Founder, Scalvex</span>
          <span className="text-xs text-muted-foreground">3 min read · SEO & Conversion</span>
        </div>
      </header>
      ...
      <section className="mb-8 max-w-2xl mx-auto">
        <Card className="bg-background p-4 border-l-4 border-accent">
          ...
          <p className="mb-2">Service businesses, consultants, agencies, and founders who want to generate consistent, high-quality leads from their website.</p>
        </Card>
      </section>
      <Separator className="my-8" />
      <section className="mb-10 max-w-2xl mx-auto">
        <Card className="bg-muted/40 p-6 mb-6">
          ...
          <p className="text-base leading-relaxed mb-2">Across 100+ service business audits, the same pattern emerges: sites get visits, but few convert. The issue isn’t traffic—it’s friction, confusion, and missing trust signals. Most agencies miss these, but they’re fixable.</p>
        </Card>
      </section>
      <Separator className="my-8" />
      <section className="mb-10 max-w-2xl mx-auto">
        <h2 className="text-2xl font-bold mb-4">Why Most SEO-First Sites Don’t Convert</h2>
        <Card className="bg-background p-4 border-l-4 border-accent">
          ...
          <ul className="list-disc list-inside mb-2 text-muted-foreground">
            <li>SEO and conversion are treated as separate projects</li>
          ...
          <p className="mb-2">Visual polish and rankings don’t fix these. Action and clarity do.</p>
        </Card>
      </section>
      <Separator className="my-8" />
      <section className="mb-10 max-w-2xl mx-auto">
        <h2 className="text-2xl font-bold mb-4">SEO-First Website Optimization Checklist</h2>
        <ol className="list-decimal list-inside space-y-8">
          <li>
            <h3 className="text-lg font-semibold mb-2">Unify SEO and Conversion</h3>
            <p className="mb-2">Build every page for both search and conversion. Don’t treat them as separate projects.</p>
      ...
      <section className="mb-10 max-w-2xl mx-auto">
        <Card className="bg-background p-6 border border-accent">
          <h3 className="text-lg font-semibold mb-2">Ready to Turn SEO Into Leads?</h3>
          <p className="text-base leading-relaxed mb-4">Get a free, expert-led audit. You’ll discover exactly what’s blocking conversions, what to fix, and how to turn traffic into qualified leads. No sales pitch—just actionable insights from real client projects.</p>
